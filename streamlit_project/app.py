...
uploadded_file = st.sidebar.file_uploader("Choose a file")
if uploadded_file is not None:
    bytes_data = uploadded_file.getvalue()
    ...
    if st.sidebar.button("Show Analysis"):
        ...
        # Assuming `col1` and `col2` are defined as columns using Streamlit's layout functions:
        col1, col2 = st.columns(2)
